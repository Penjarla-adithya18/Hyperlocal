...
-- =============================================================
-- Passwords are all PBKDF2 hashes of "Password@123" (compatible with _shared/crypto.ts)
...
('11111111-0001-0001-0001-000000000001','Ravi Kumar Sharma',   '+919876540001','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',72,'active',  true, null,null,'{"Plumbing","Pipe fitting","Basic electrical"}'),
('11111111-0001-0001-0001-000000000002','Priya Devi',          '+919876540002','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',85,'trusted', true, null,null,'{"Cooking","Catering","Food packaging"}'),
('11111111-0001-0001-0001-000000000003','Mohammed Irfan',      '+919876540003','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',60,'active',  true, null,null,'{"Driving","Heavy vehicle","Logistics"}'),
('11111111-0001-0001-0001-000000000004','Sunita Bai',          '+919876540004','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',50,'basic',   false,null,null,'{"Cleaning","Housekeeping"}'),
('11111111-0001-0001-0001-000000000005','Arjun Reddy Nalla',   '+919876540005','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',90,'trusted', true, null,null,'{"Carpentry","Furniture assembly","Wood polish"}'),
('11111111-0001-0001-0001-000000000006','Lakshmi Venkatesan',  '+919876540006','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',78,'active',  true, null,null,'{"Tailoring","Embroidery","Dress making"}'),
('11111111-0001-0001-0001-000000000007','Deepak Yadav',        '+919876540007','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',55,'basic',   false,null,null,'{"Security guard","Night patrol"}'),
('11111111-0001-0001-0001-000000000008','Kavitha Subramaniam',  '+919876540008','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',82,'trusted', true, null,null,'{"Data entry","MS Office","Typing 60wpm"}'),
('11111111-0001-0001-0001-000000000009','Ramesh Babu Patel',   '+919876540009','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',67,'active',  true, null,null,'{"Painting","Wall texture","Waterproofing"}'),
('11111111-0001-0001-0001-000000000010','Anjali Singh',        '+919876540010','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',74,'active',  true, null,null,'{"Reception","Customer service","Front desk"}'),
('11111111-0001-0001-0001-000000000011','Suresh Mondal',       '+919876540011','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',58,'basic',   false,null,null,'{"Loading","Unloading","Warehouse"}'),
('11111111-0001-0001-0001-000000000012','Nandini Krishnaswamy','+919876540012','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',88,'trusted', true, null,null,'{"Nursing","Patient care","First aid"}'),
('11111111-0001-0001-0001-000000000013','Rajendra Prasad',     '+919876540013','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',63,'active',  true, null,null,'{"Electrician","Wiring","Panel board"}'),
('11111111-0001-0001-0001-000000000014','Meena Kumari Devi',   '+919876540014','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',70,'active',  true, null,null,'{"Cooking","Tiffin service","Meal prep"}'),
('11111111-0001-0001-0001-000000000015','Vinod Kumar Gupta',   '+919876540015','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',53,'basic',   false,null,null,'{"Gardening","Landscaping","Plant care"}'),
('11111111-0001-0001-0001-000000000016','Padmavathi Rao',      '+919876540016','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',81,'trusted', true, null,null,'{"Beautician","Makeup","Mehendi"}'),
('11111111-0001-0001-0001-000000000017','Ganesh Mahato',       '+919876540017','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',66,'active',  true, null,null,'{"AC repair","Refrigerator repair","Appliance service"}'),
('11111111-0001-0001-0001-000000000018','Saranya Murugesan',   '+919876540018','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',75,'active',  true, null,null,'{"Textile","Weaving","Fabric quality check"}'),
('11111111-0001-0001-0001-000000000019','Bhim Rao Ambedkar',   '+919876540019','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',59,'basic',   false,null,null,'{"Construction","Masonry","Brick work"}'),
('11111111-0001-0001-0001-000000000020','Tara Kumari',         '+919876540020','worker',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',84,'trusted', true, null,null,'{"Accounting","GST filing","Tally ERP"}'),

-- ── EMPLOYERS ─────────────────────────────────────────────────
('22222222-0002-0002-0002-000000000001','Harish Agarwal',      '+919876540021','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',80,'trusted', true,
...
('22222222-0002-0002-0002-000000000002','Rekha Nair',          '+919876540022','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',75,'active',  true,
...
('22222222-0002-0002-0002-000000000003','Sanjay Mehta',        '+919876540023','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',88,'trusted', true,
...
('22222222-0002-0002-0002-000000000004','Latha Raghunathan',   '+919876540024','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',62,'active',  false,
...
('22222222-0002-0002-0002-000000000005','Prakash Joshi',       '+919876540025','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',55,'basic',   false,
...
('22222222-0002-0002-0002-000000000006','Deepa Chandrasekhar', '+919876540026','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',91,'trusted', true,
...
('22222222-0002-0002-0002-000000000007','Ranjit Singh Bhandari','+919876540027','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',73,'active',  true,
...
('22222222-0002-0002-0002-000000000008','Usha Venkataraman',   '+919876540028','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',68,'active',  true,
...
('22222222-0002-0002-0002-000000000009','Kishore Kumar Naidu', '+919876540029','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',77,'active',  true,
...
('22222222-0002-0002-0002-000000000010','Fatima Begum',        '+919876540030','employer',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',85,'trusted', true,
...
('33333333-0003-0003-0003-000000000001','Admin Superuser',     '+919000000001','admin',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',100,'trusted',true,null,null,'{}'),
('33333333-0003-0003-0003-000000000002','Platform Moderator',  '+919000000002','admin',
 'pbkdf2$210000$3XYCwzJBlhZB6dXXxwnHjw$09o3FMsDEVcFSsEiYyszdXYMAVdCnB54O1iVWW9mvkY','true',95,'trusted', true,null,null,'{}');
